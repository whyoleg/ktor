...
class PostTest : ClientLoader() {
    @Test
    fun testPostString() = clientTests(listOf("Fetch")) {
        test { client ->
    ...
    @Test
    fun testHugePost() = clientTests(listOf("Fetch", "Darwin", "CIO", "Curl", "DarwinLegacy", "WinHttp")) {
        test { client ->
    ...
    @Test
    fun testWithPause() = clientTests(listOf("Fetch", "Darwin", "CIO", "DarwinLegacy")) {
        config {
            install(HttpTimeout) {
