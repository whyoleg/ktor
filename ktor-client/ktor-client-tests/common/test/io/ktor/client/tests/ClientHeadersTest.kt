...
class ClientHeadersTest : ClientLoader() {
    ...
    fun testHeadersReturnNullWhenMissing() = clientTests(
        listOf("Java", "Curl", "Fetch", "Darwin", "DarwinLegacy", "WinHttp")
    ) {
        test { client ->
    ...
    @Test
    fun testContentNegotiationMediaType() = clientTests(listOf("Java", "Curl", "Fetch", "Darwin", "DarwinLegacy")) {
        test { client ->
    ...
    @Test
    fun testHeadersMerge() = clientTests(listOf("Fetch")) {
        test { client ->
    ...
    @Test
    fun testAcceptMerge() = clientTests(listOf("Fetch")) {
        test { client ->
    ...
    @Test
    fun testSingleHostHeader() = clientTests(listOf("Fetch", "Android", "Java")) {
        test { client ->
    ...
    @Test
    fun testRequestHasContentLength() =
        clientTests(listOf("Java", "Curl", "Fetch", "Darwin", "DarwinLegacy", "WinHttp")) {
        test { client ->
