 ...
 */
public typealias ConsumeEachBufferVisitor = suspend (buffer: ByteBuffer, last: Boolean) -> Boolean
...
public suspend inline fun ByteReadChannel.consumeEachBufferRange(crossinline visitor: ConsumeEachBufferVisitor) {
